          ...
          <div class="max-w-[850px] space-y-6">
            ...
            <div class="text-base">
              ...
              <div class="flex justify-between py-4">
                <div class="px-5 py-2 bg-purple-500 rounded-full text-white">
                  <?php previous_post_link('%link', 'Previous Post', true); ?></div>
                <div class="px-5 py-2 bg-blue-500 rounded-full text-white"><?php next_post_link('%link', 'Next Post', true); ?>
                </div>
              </div>
            </div>
          </div>
